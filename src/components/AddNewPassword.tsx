...
export default function ChangePasswordForm() {
  ...
  const handleSubmit = async (
    ...
    try {
      const response = await fetch("/api/auth/add_new_password", {
        method: "POST",
        headers: {
      ...
      setErrors({
        newPassword: "Password added failed. Please try again.",
        confirmPassword: "Password added failed. Please try again.",
      });
